...
export default class Search {
    ...
    constructor() {
        ...
        this.inputField = document.querySelector("#live-search-field")  //field element has this id
    ...
    sendRequest() {
        //axios or fetch to send off async requests
    ...
    renderResultsHTML(posts) {
        if (posts.length) {
            ...
            this.resultsArea.innerHTML = `<p class="alert alert-danger text-center shadow-sm">Sorry. Could not find any results for that search.</p>`
        }
        this.hideLoaderIcon()
